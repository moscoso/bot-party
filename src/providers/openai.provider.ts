...
export class OpenAIProvider implements AIProvider {
    ...
    async init(systemPrompt: string): Promise<void> {
        return wrapProviderCall("openai", "assistant initialization", async () => {
    ...
    async chat(messages: ChatMessage[]): Promise<string> {
        return wrapProviderCall("openai", "chat completion", async () => {
    ...
    async chatStateful(userContent: string): Promise<string> {
        ...
        return wrapProviderCall("openai", "stateful chat", async () => {
